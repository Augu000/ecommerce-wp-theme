...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'custom-woocomerce' ); ?></a>
				...
				<div class="col-md-4">
					<ul class="announcement-bar__list">
						<li>
							...
							<a href="tel: +3706788888" class="text-decoration-none">tel: +3706788888</a>
						</li>
						<li>
							<i class="bi bi-envelope rounded-circle"></i>
							<a href="mailto: 4Jk7l@example.com" class="text-decoration-none">4Jk7l@example.com</a>
						</li>
					</ul>
				</div>
				...
				<div class="row">
					<div class="col-12 d-flex justify-content-center">
						<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false">
							...
							<?php esc_html_e( 'Primary Menu', 'custom-woocomerce' ); ?>
						</button>
					</div>
